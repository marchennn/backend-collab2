...
SCHEMA_PATH = Path('/home/gmh/project-colab2/backend-collab2/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'linux-arm64-openssl-1.1.x': '/home/gmh/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-linux-arm64-openssl-1.1.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    sensor: 'actions.sensorActions[models.sensor]'
    led: 'actions.ledActions[models.led]'
    ...
    def __init__(
        ...
        *,
        ...
        self._set_generated_properties(
            ...
            default_datasource_name='database',
        )

        self.sensor = actions.sensorActions[models.sensor](self, models.sensor)
        self.led = actions.ledActions[models.led](self, models.led)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/home/gmh/project-colab2/backend-collab2/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.sensor = sensorBatchActions(self)
        self.led = ledBatchActions(self)
...
class sensorBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.sensorCreateInput,
        include: Optional[types.sensorInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.sensor,
    ...
    def create_many(
        self,
        data: List[types.sensorCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.sensorWhereUniqueInput,
        include: Optional[types.sensorInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update_many(
        self,
        data: types.sensorUpdateManyMutationInput,
        where: types.sensorWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.sensor,
    ...
    def delete_many(
        self,
        where: Optional[types.sensorWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.sensor,
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ledBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.ledCreateInput,
        include: Optional[types.ledInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.led,
    ...
    def create_many(
        self,
        data: List[types.ledCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.ledWhereUniqueInput,
        include: Optional[types.ledInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update_many(
        self,
        data: types.ledUpdateManyMutationInput,
        where: types.ledWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.led,
    ...
    def delete_many(
        self,
        where: Optional[types.ledWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.led,
